...
public class SongMessage implements Serializable {
    ...
    public static final int LRCDOWNLOADED = (i++); // lrcview 歌词下载完成
    public static final int LRCLOADED = (i++); // lrcview 歌词下载完成

    public static final int LRCTYPEDES = (i++); // 桌面 歌词
    public static final int DESLRCDOWNLOADED = (i++); // 桌面歌词下载完成
    public static final int DESLRCLOADED = (i++); // 桌面 歌词下载完成

    public static final int LRCTYPELOCK = (i++); // 锁屏歌词
    public static final int LOCKLRCDOWNLOADED = (i++); // 锁屏 歌词下载完成
    public static final int LOCKLRCLOADED = (i++); // 锁屏歌词下载完成
